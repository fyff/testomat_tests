...
from src.web.pages.new_project_details_page import NewProjectDeatilsPage
...
class NewProjectPage:
    ...
    def click_create(self) -> NewProjectDeatilsPage:
        ...
        return NewProjectDeatilsPage(self.page)
