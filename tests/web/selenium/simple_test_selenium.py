...
from src.web.selenium import LoginPage, LoginPageV2
from tests.fixtures.config import Config


def test_selenium_login_and_search(driver: WebDriver, configs: Config):
    wait = WebDriverWait(
        driver, 10, poll_frequency=0.1, ignored_exceptions=[NoSuchElementException, StaleElementReferenceException]
    )
    ...
    wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, ".common-flash-success")))

    target_project = "Manufacture light"
    driver.find_element(By.CSS_SELECTOR, "#search").send_keys(target_project)
    ...
    driver.find_element(By.CSS_SELECTOR, ".search").is_displayed()
    driver.find_element(By.CSS_SELECTOR, "div.mainnav-menu").is_displayed()
