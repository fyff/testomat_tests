...
invalid_login_test_cases = [
    ...
    pytest.param(
        faker.pystr(min_chars=240, max_chars=240) + "@example.com", "config_password", id="email_max_length_valid"
    ),  # approx 252 chars
    pytest.param(
        faker.pystr(min_chars=250, max_chars=250) + "@example.com", "config_password", id="email_over_max_length"
    ),  # approx 262 chars
    ...
    pytest.param(
        faker.pystr(min_chars=128, max_chars=128), "config_email", id="password_max_length_valid"
    ),  # 128 chars
    pytest.param(faker.pystr(min_chars=129, max_chars=129), "config_email", id="password_over_max_length"),  # 129 chars
    # Security: XSS
