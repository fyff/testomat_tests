...
class CookieHelper:
    """
    Helper class providing utility methods for manipulating cookies
    within a Playwright BrowserContext.
    """
...
def clear_browser_state(page: Page) -> None:
    """
    Clears cookies, local storage, and session storage for the given Playwright Page's context.
    This ensures a clean state for subsequent test actions on that page.
    """
